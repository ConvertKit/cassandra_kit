...
module CassandraKit
  ...
  module Type
    ...
    class Base
      ...
      #   used in all of CassandraKit's public interfaces
      #
      def cql_name
    ...
    # created using the {CassandraKit.uuid} method, and a value can be checked to see
    # if it is a UUID recognized by CassandraKit using the {CassandraKit.uuid?} method.
    #
    # @see https://cassandra.apache.org/doc/latest/cql/types.html
    #   CQL3 data type documentation
    #
