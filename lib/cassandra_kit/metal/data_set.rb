...
module CassandraKit
  module Metal
    ...
    class DataSet
      ...
      #
      #   @example
      #     posts.where(blog_subdomain: 'cassandra', permalink: 'cassandra_kit').
      #       update(title: 'Announcing CassandraKit 1.0')
      #
      ...
      #       set(title: 'Announcing CassandraKit 1.0')
      ...
      # @example
      #   post_analytics.
      #     where(blog_subdomain: 'cassandra', permalink: 'cassandra_kit').
