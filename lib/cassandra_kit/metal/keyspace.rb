...
module CassandraKit
  module Metal
    ...
    class Keyspace
      ...
      #
      # @!method batch
      #   (see CassandraKit::Metal::BatchManager#batch)
      #
      ...
      #
      # @!method sanitize
      #   (see CassandraKit::Metal::Keyspace.sanitize)
      #
      ...
      def configure(configuration = {})
        if configuration.key?(:thrift)
          warn "CassandraKit no longer uses the Thrift transport to communicate " \
      ...
      def extract_cassandra_error_policy(configuration)
        value = configuration.fetch(:cassandra_error_policy, ::CassandraKit::Metal::Policy::CassandraError::ClearAndRetryPolicy)
