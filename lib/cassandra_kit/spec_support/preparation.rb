module CassandraKit
  module SpecSupport
    ...
    #     CassandraKit::SpecSupport::Preparation.setup_database
    #
    ...
    #
    #     # one time database setup
    #     CassandraKit::SpecSupport::Preparation
    ...
    class Preparation
      ...
      #   which CassandraKit record classes reside. All files in these
      ...
      #
      def drop_keyspace
        keyspace = CassandraKit::Record.connection.schema
      ...
      #
      # @return [Array<Class>] all CassandraKit record classes
      #
      def record_classes
        load_all_models
        CassandraKit::Record.descendants
      end

      #
      # Loads all files in the models directory under the assumption
      # that CassandraKit record classes live there.
      #
      def load_all_models
