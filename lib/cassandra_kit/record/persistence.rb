  ...
  module Record
    ...
    module Persistence
      ...
      module ClassMethods
        ...
        #     title: 'CassandraKit: The Next Generation'
        #   )
        #
        ...
        #     post.title = 'CassandraKit: The Next Generation'
        #   end
        #
        ...
        # @return [CassandraKit::Record] a new instance of this record class
        ...
        # @private
        def_delegator 'CassandraKit::Record', :connection
      end
      ...
      #   post.title = 'CassandraKit: The Next Generation'
      #   post.key_attributes
      #     #=> {:blog_subdomain=>'cassandra', :permalink=>'cassandra_kit'}
      #
      # @since 1.0.0
      #
      def key_attributes
        @cassandra_kit_attributes.slice(*self.class.key_column_names)
      end
      ...
      def loaded?(column = nil)
        !!@loaded && (column.nil? || @cassandra_kit_attributes.key?(column.to_sym))
      end
      ...
      def attributes_for_create
        @cassandra_kit_attributes.each_with_object({}) do |(column, value), attributes|
          attributes[column] = value unless value.nil?
        end
      end

      def attributes_for_update
        @cassandra_kit_attributes_for_update ||= {}
      end

      def attributes_for_deletion
        @cassandra_kit_attributes_for_deletion ||= []
      end
