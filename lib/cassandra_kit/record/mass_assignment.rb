...
module CassandraKit
  module Record
    ...
    #
    # CassandraKit supports mass-assignment protection in both the Rails 3 and Rails
    # 4 paradigms. Rails 3 applications may define `attr_protected` and
    # `attr_accessible` attributes in {Record} classes. In Rails 4, CassandraKit will
