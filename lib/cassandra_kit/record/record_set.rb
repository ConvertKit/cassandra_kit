...
module CassandraKit
  module Record
    ...
    class RecordSet < SimpleDelegator
      ...
      extend CassandraKit::Util::HashAccessors
      include Enumerable
      include BulkWrites
      ...
      def initialize(target_class, attributes = {})
        ...
        @target_class, @cassandra_kit_attributes = target_class, attributes
        super(target_class)
      end
      ...
      # permalink) = ("cassandra", "cassandra_kit")`, the record set can be thought of
      # like so:
      #
      # ```ruby
      # {
      #   "cassandra" => {
      #     "cassandra_kit" => #<Post blog_subdomain: "cassandra",
      #                        permalink: "cassandra_kit", title: "CassandraKit">
      #   }
      # }
      # ```
      #
      ...
      #   Post['cassandra_kit'] # returns a RecordSet
      #
      # @example Fully specified primary key
      #   Post['cassandra_kit']['cassandra'] # returns an unloaded Record
      #
      ...
      #
      # `Post.allow_filtering!.where(title: 'CassandraKit 0')`
      #
      ...
      #   to be counted
      def count
        raise CassandraKit::Record::DangerousQueryError.new
      end
      ...
      #
      # @return [CassandraKit::Metal::DataSet] the data set underlying this record
      #   set
      #
      def data_set
      ...
      def attributes
        cassandra_kit_attributes
      end

      def attributes=(attrs)
        self.cassandra_kit_attributes = attr
      end

      attr_accessor :cassandra_kit_attributes
      ...
      hattr_reader :cassandra_kit_attributes, :select_columns, :scoped_key_values,
