...
module CassandraKit
  module Schema
    ...
    class TableDescDsl < BasicObject
      ...
      # type - The type of the column. Either a `CassandraKit::Type` or a symbol.
      #   See `CassandraKit::Type`.
      #
      ...
      #   `CassandraKit::Type` or a symbol. See `CassandraKit::Type`.
      #
      def list(name, type)
