module CassandraKit
  ...
  module Instrumentation
    ...
    module ModuleMethods
      ...
      #    instrument :create, data: {topic: "create.cassandra_kit", table_name: table_name}
      #
      # @param method_name [Symbol,String] The method to instrument
      #
      # @param opts [String] :topic ("#{method_name}.cassandra_kit") The name
      ...
      def instrument(method_name, opts)
        data = opts[:data]
        topic = opts.fetch(:topic, "#{method_name}.cassandra_kit")
